...
if ( ! defined( 'BUBBAHUB_APP_VERSION' ) ) define( 'BUBBAHUB_APP_VERSION', '1.3.4' );
...
require_once BUBBAHUB_APP_DIR . 'includes/class-bubbahub-frontend-api.php';
...
if ( class_exists( 'BubbaHubPlugin_Frontend_API' ) && method_exists( 'BubbaHubPlugin_Frontend_API', 'boot' ) ) {
...
function bubbahub_app_enqueue_assets_130() {
    ...
    if ( file_exists( BUBBAHUB_APP_DIR . 'assests/wp-bridge.js' ) ) {
        ...
        wp_localize_script( 'bubbahub-app-wp-bridge', 'BubbaHubWP', array(
            ...
            'frontendListingsUrl' => esc_url_raw( rest_url( 'bubbahub/v1/frontend-listings' ) ),
...
// Render exactly one React mount point per page.
...
add_filter( 'plugin_action_links_' . plugin_basename( __FILE__ ), function ( $links ) {
    ...
    $links[] = '<a href="' . esc_url( rest_url( 'bubbahub/v1/frontend-listings' ) ) . '" target="_blank">Frontend API</a>';
    return $links;
} );
